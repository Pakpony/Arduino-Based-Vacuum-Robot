...
void setup() { //ตั้งค่าเซอร์โวมอเตอร์ให้หมุนไปที่มุม 115 องศา และอ่านค่าระยะทางจากเซ็นเซอร์อัลตราโซนิกหลายครั้งเพื่อเก็บค่าเริ่มต้น
...
void loop() { //เตรียมตัวแปรสำหรับเก็บค่าระยะทางด้านซ้ายและขวา และหน่วงเวลา 40 มิลลิวินาทีก่อนการทำงานถัดไป
 ...
 if(distance<=20) //ควบคุมการเคลื่อนที่ของหุ่นยนต์ โดยใช้ข้อมูลระยะทางจากเซ็นเซอร์ อัลตราโซนิก เพื่อตัดสินใจว่าหุ่นยนต์ควรจะหยุด,ถอยหลัง หรือเลี้ยวไปทางซ้ายหรือขวาเมื่อพบสิ่งกีดขวางที่ระยะทางใกล้
 {
  moveStop();
  delay(100);
  moveBackward();
